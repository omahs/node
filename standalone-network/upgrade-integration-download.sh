...
cosmovisor start
#cosmovisor start >> ~/.zetacored/cosmovisor.log 2>&1  &
...
#  --upgrade-height 10 \
#  --upgrade-info '{"binaries":{"zetaclientd-darwin/arm64":"https://athens3-testnet.s3.amazonaws.com/binaries/zetaclientd?checksum=sha256:9a10a058f33bb55ce6af420716bf6df37f43596dfe7ccdc86f90d2a89efdc027","zetacored-darwin/arm64":"https://athens3-testnet.s3.amazonaws.com/binaries/zetacored?checksum=sha256:b014b086c0de4ddce46087a8f24940e68cf115b3406f3a9792464a41247fb59e"}}' \
#  --description "test" \
#  --title "test-upgrade" \
#  --from zeta \
...
#
#tail -f ~/.zetacored/cosmovisor.log
