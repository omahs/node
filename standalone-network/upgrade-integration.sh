...
sleep 7
zetacored tx gov submit-proposal software-upgrade $UpgradeName --from zeta --deposit 100000000azeta --upgrade-height 10 --title $UpgradeName --description $UpgradeName --keyring-backend test --chain-id localnet_101-1 --yes
sleep 7
